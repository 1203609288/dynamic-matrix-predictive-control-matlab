...
DMC_yideal	= zeros( size(y_step) );	% 到达阶跃稳态的响应, HP足够长,	理想状态
...
msg	= sprintf('基本的DMC Controler:	HP=%d, HM=%d, A(%d,1)=%f。LRJ修正方法1', m_nHP,	m_nHM, m_nHP,A(m_nHP,1));
